...
func newGroup(db *gorm.DB, opts ...gen.DOOption) group {
	...
	_group.CreatedTime = field.NewTime(tableName, "created_time")
	_group.UpdatedTime = field.NewTime(tableName, "updated_time")
...
func (g *group) updateTableName(table string) *group {
	...
	g.CreatedTime = field.NewTime(table, "created_time")
	g.UpdatedTime = field.NewTime(table, "updated_time")
...
func (g *group) fillFieldMap() {
	...
	g.fieldMap["created_time"] = g.CreatedTime
	g.fieldMap["updated_time"] = g.UpdatedTime
}
