...
func newMenu(db *gorm.DB, opts ...gen.DOOption) menu {
	...
	_menu.CreatedTime = field.NewTime(tableName, "created_time")
	_menu.UpdatedTime = field.NewTime(tableName, "updated_time")
...
type menu struct {
	...
	URI         field.String // URI地址
	Level       field.Int32  // 节点等级
	Pid         field.Int32  // 父节点菜单ID
