...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.PwdWrong = field.NewInt32(tableName, "pwd_wrong")
...
type user struct {
	...
	Email       field.String
	Desc        field.String
	LoginTime   field.Int32
	PwdWrong    field.Int32
	Status      field.Int32
...
func (u *user) updateTableName(table string) *user {
	...
	u.PwdWrong = field.NewInt32(table, "pwd_wrong")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["pwd_wrong"] = u.PwdWrong
