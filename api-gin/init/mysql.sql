...
VALUES
	...
	(2, 'Dashboard', '/home/index', 2, 1, 'dashboard', 1, 101, ''),
    (3, 'Management', '/panel', 1, 0, 'config', 1, 900, ''),
	(4, 'User', '/panel/users', 2, 3, 'user', 1, 901, ''),
	(5, 'Groups', '/panel/groups', 2, 3, 'group', 1, 902, ''),
	(6, 'Menus', '/panel/menus', 2, 3, 'tree', 1, 903, '');
