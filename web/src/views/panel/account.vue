<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" border style="width: 100%;">
      ...
      <el-table-column label="Status">
        <template slot-scope="{row}">
          <el-switch :value="row.status" @click.native="switchStatus(row)" />
        </template>
      </el-table-column>
    ...
    <pagination :total="total" :page.sync="filter.page" :limit.sync="filter.size" @pagination="getList" />

    <el-dialog :title="dialogOne.dialogStatus === 'create' ? 'Create' : 'Edit'" :visible.sync="dialogOne.dialogFormVisible">
    ...
    <el-dialog title="Edit" :visible.sync="dialogTwo.dialogFormVisible">
